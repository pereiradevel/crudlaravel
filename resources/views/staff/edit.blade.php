...
@yield('page_title', 'Editar Funcionário')
...
<div class="mb-6 flex items-center gap-3">
    ...
    <div>
        <h2 class="text-xl font-bold text-slate-800">Editar Funcionário: {{ $staff->nome }}</h2>
        <p class="text-xs text-slate-400 mt-1">Atualize os dados cadastrais deste integrante da equipe.</p>
    </div>
</div>

<div class="max-w-2xl bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
    <form action="{{ route('staff.update', $staff->id) }}" method="POST" class="p-8 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" name="nome" id="nome" value="{{ old('nome', $staff->nome) }}" required
            ...
            <div>
                ...
                <input type="text" name="cargo" id="cargo" value="{{ old('cargo', $staff->cargo) }}" required
            ...
            <div>
                ...
                <input type="text" name="telefone" id="telefone" value="{{ old('telefone', $staff->telefone) }}"
